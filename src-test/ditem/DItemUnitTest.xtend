...
/***
 * Uses groupId:com.github.oehme.xtend, artifactId:xtend-junit for Unit tests. But this implementation has bugs
 */
//@JUnit
//@Hamcrest
class DItemUnitTest {
...
//		item.personProp.addressesProp.head.value.city = "Köln"
